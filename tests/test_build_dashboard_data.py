...
class BuildDashboardDataTest(unittest.TestCase):
    def test_build_dashboard_payload_contains_phase_and_data_summaries(self) -> None:
        ...
        self.assertEqual(payload["data"]["content_generation"]["status"], "generated_in_chat")
        self.assertEqual(payload["data"]["content_generation"]["brand_count"], 5)
        self.assertEqual(payload["data"]["content_generation"]["image_slot_count"], 25)
        self.assertEqual(len(payload["data"]["content_generation_brands"]), 5)
        self.assertEqual(len(payload["data"]["content_generation_brands"][0]["concepts"]), 5)
