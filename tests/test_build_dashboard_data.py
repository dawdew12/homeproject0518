...
class BuildDashboardDataTest(unittest.TestCase):
    def test_build_dashboard_payload_contains_phase_and_data_summaries(self) -> None:
        ...
        self.assertEqual(payload["data"]["storage"]["github_history"]["weekly_key"], "2026-W21")
        ...
        self.assertEqual(payload["architecture"]["overall_progress"]["completed_phase_count"], 9)
        self.assertEqual(payload["architecture"]["overall_progress"]["percent"], 75)
        ...
        self.assertEqual(payload["next_step"]["phase"], "PHASE 10")
    ...
    def test_write_dashboard_payload_creates_json_file(self) -> None:
        ...
        self.assertEqual(saved["verification"]["test_count"], 30)
